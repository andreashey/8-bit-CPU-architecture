...
REM
REM Generated by Vivado on Fri Jul 18 18:10:27 +0200 2025
...
echo "xvlog --incr --relax -L uvm -prj CPU_sim_vlog.prj"
call xvlog  --incr --relax -L uvm -prj CPU_sim_vlog.prj -log xvlog.log
